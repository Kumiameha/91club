   ...
   <head>
      ...
      <script>
         function pageRedirect() {
              window.location.replace("https://luckylottery.tech/game.php");
          }      
   ...
   <body>
      <div class="root">
         ...
         <div class="cp">
            ...
            <p><span id="upiC" style="color:red"><span id="myText"><?php echo $selectupiresult['upi1'] ; ?></span></span>&nbsp;&nbsp;&nbsp;<a onclick="copyContent()"><i class="fa fa-clone"></i></a></p>
         </div>
         <br>
         <a id="qrcodeC">
            <div id="qrcode" style="display:none;"></div>
            <div id="qrcodeImg"><img style="height:200px" src="images/qrpage.png"></div>
