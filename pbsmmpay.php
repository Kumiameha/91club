...
$callback_url = "https://91club.in.net/pbsmmpay/txnResult.php";  //callback 

if ($gateway_type == "Robotics") {
    $RECHPAY_TXN_URL = 'https://allrcodepay.in.net/order/paytm';

    $upiuid = 'paytmqr1uif541xwb@paytm'; // Its Paytm Business UPI Unique ID.
